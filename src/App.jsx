...
import footerlogo from './images/DRAGON KOSKA (1).png';
...
function App() {
  return (
    ...
    <p>
        ...
        We hope to showcase (non-)local sounds, carefully curated by people's taste - boundless of genre. The studio serves as an open space for all people to enjoy music together. If you think you have 
    ...
    <p>
        Tune in live, right here, or using the back-up link for non-chrome and mobile streaming (still working on it, sorry). 
        Re-listen to any broadcast via Koska's <a href="https://on.soundcloud.com/LG9iX" target="_blank" rel="noopener noreferrer">Soundcloud</a>
. We will be regularly updating the page to feature all our back-catalogue. 
    </p>
</div>
<div className="footer-right">
    <img src={footerlogo} alt="Footer Logo" />
    <p>All graphics designed by <a href="https://l.instagram.com/?u=https%3A%2F%2Fanntonnio1-portfolio.my.canva.site%2Fportfolio-sufukante%3Ffbclid%3DPAAaaXq-WmlwB5-j28vjtSRtsxzZKrjY6steHDVfFeZb64V4AVpBM1oTD7WjQ_aem_AXD1wbiDZJqk_lNtNOMcgJpznntCPLl6CwOEc6ljSVoFSW96qXJLm_sU7dnf86XqpJ8&e=AT23AuvWwAnvvZl3CIoT12gDVtXSC-3jfKt7YW2e8G-yc0_jWitpXFMsgKQMs7B2EGAszjW2pedfx1hmw0ofwwNgHfbLNF8re4VdomeWHZ0_qhHbysQ_yNQ" target="_blank" rel="noopener noreferrer">Antonio</a></p>
</div>
</footer>
</div>
);
